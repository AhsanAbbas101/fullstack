...
const CreateNew = (props) => {
  const content = useField('text')//useState('')
  const author = useField('text')//useState('')
  const info = useField('text')//useState('')
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit} onReset={handleReset} >
        <div>
          content
          <input name='content' {...content.state} />
        </div>
        <div>
          author
          <input name='author' {...author.state}  />
        </div>
        <div>
          url for more info
          <input name='info' {...info.state} />
        </div>
        <span>
...
const App = () => {
  ...
  return (
    ...
    <div>
      ...
      <Routes>
        <Route path='/anecdote/:id' element={<Anecdote anecdote={matchedAnecdote}/>}/>
